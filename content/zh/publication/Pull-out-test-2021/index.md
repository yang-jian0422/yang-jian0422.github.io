...
url_pdf: '/zh/publication/pull-out-test-2021/paper.pdf'
...
无量纲荷载系数 $N_{\mathrm{pf}}$ 描述锚杆的支盘埋置深度对极限抗拔力的影响，定义为:
...
支盘锚杆的承载力主要有两部分组成：支盘端阻力 $Q$ 与锚固段的侧阻力 $P_\mathrm{s}$，则极限承载力 $P_\mathrm{f}$ 可表示为
